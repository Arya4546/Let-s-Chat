...
const HomePage = () => {
  ...
  useEffect(() => {
    ...
    console.log("Outgoing requests IDs updated:", Array.from(outgoingIds));
  }, [outgoingFriendReqs]);
    ...
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="container mx-auto space-y-10">
        ...
        <section>
          ...
          {usersError && (
            <div className="alert alert-error">
              <span>Error loading recommended users: {usersError.message}</span>
            </div>
          )}

          {outgoingReqsError && (
            <div className="alert alert-error">
              <span>Error loading outgoing requests: {outgoingReqsError.message}</span>
            </div>
          )}
